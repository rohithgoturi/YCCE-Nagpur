...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[70vh] overflow-hidden bg-[#f4f6f8]">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-gray-100/10 to-transparent" />
      ...
      <motion.div
        ...
        className="relative z-10 max-w-6xl mx-auto px-6 flex items-start min-h-[70vh]"
      >
        <div className="max-w-xl m-0">
          ...
          <p className="mt-4 text-blue-950 text-xl font-semibold">From Thought to Thing</p>
